...
\node<2-> [anchor=center, below right = 0.45cm and 0.25cm of brain] (input2) {\includegraphics[width=0.25\textwidth]{figures/un_pipe.jpg}};
\node<2-> [anchor=center, above right = 1cm and 0.25cm of brain] (output2) {``This is a pipe.''};

\begin{pgfonlayer}{background}
\path [line] (input1.east) to [out=45, in=-45] (output1.east);
\path<2-> [line] (input2.west) to [out=135, in=-135] (output2.west);
\end{pgfonlayer}
\end{tikzpicture}
\end{figure}
\vspace{2em}
...
%% TODO: insert FYP slide here

\begin{frame}{Some theoretical understanding of multi-task benefits}
\begin{figure}
\centering
