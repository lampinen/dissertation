\chapter{Supplemental material for chapter \ref{chapter:zero_shot_via_homm}} \label{appendix:zero_shot_via_homm}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{2-HoMM/figures/why_meta_mapping.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{2-HoMM/figures/continual/continual_learning.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{2-HoMM/figures/poly/basic_results_sweeping.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{2-HoMM/figures/poly/base_learning_curves.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{2-HoMM/figures/poly/meta_learning_curves.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{2-HoMM/figures/continual/continual_learning_direct_comparison.png}
...
\includegraphics[width=\textwidth]{2-HoMM/figures/poly/basic_results_over_time.png}
\caption{The polynomials domain, section \ref{sec_poly}.}
\label{supp_poly_integration_results}
\end{subfigure}%
\begin{subfigure}[t]{0.5\textwidth}
\includegraphics[width=\textwidth]{2-HoMM/figures/basic_meta_learning_integrating_over_time.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{2-HoMM/figures/poly/meta_results_conditioned_vs_hyper.png}
