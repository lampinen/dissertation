...
\textbf{Classifying task representations:} We can also train the HoMM model to classify task representations. We refer to these task-classifications as \emph{meta-classifications}. Performing meta-classifications could encourage the model to represent the relevant features of the tasks.
