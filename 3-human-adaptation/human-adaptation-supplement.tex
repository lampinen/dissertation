...
\subsection{Basic meta-learning in the cards domain}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.66\textwidth]{3-human-adaptation/figures/basic_meta_learning_cards.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.66\textwidth]{3-human-adaptation/figures/cards_nonhomoiconic_lesion.png}
